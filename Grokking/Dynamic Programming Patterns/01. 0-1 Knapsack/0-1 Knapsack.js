...
let solveKnapsackUltimate = function (profits, weights, capacity) {
  function knapsackRecursive(profits, weights, capacity, currentIndex) {
    // base checks
    if (capacity <= 0 || currentIndex >= profits.length) return 0;
...
var weights = [1, 2, 3, 5];
console.log(`Total knapsack profit: ---> ${solveKnapsackUltimate(profits, weights, 7)}`);
// console.log(`Total knapsack profit: ---> ${solveKnapsackUltimate(profits, weights, 6)}`);
